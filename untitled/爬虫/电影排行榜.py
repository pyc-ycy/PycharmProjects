...
class MovieTop(object):
    def __str__(self):
        self.start = 0
        self.param = '&filter='
        self.headers = {'User-Agent': '360chrome(Windows NT6.1; WOW64)'}
        self.movie_list = []
        self.file_path = 'E:\movie_spider.text'
    ...
    def write_text(self):
        print('开始向文件写入数据……')
        file_top = open(self.file_path, 'w', encoding='utf_8')
        try:
